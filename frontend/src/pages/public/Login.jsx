      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <div className="grid grid-cols-2 gap-4 text-left">
            <div className="p-6 rounded-[2rem] bg-white/5 border border-white/10 hover:border-blue-500/50 transition-all duration-500 group">
              <ShieldCheck className="w-8 h-8 text-blue-500 mb-4 group-hover:scale-110 transition-transform" />
              <h4 className="text-white font-bold mb-1">Secure</h4>
              <p className="text-slate-500 text-xs font-medium">World-class encrypted data protection protocols.</p>
            </div>
            <div className="p-6 rounded-[2rem] bg-white/5 border border-white/10 hover:border-rose-500/50 transition-all duration-500 group">
              <Heart className="w-8 h-8 text-rose-500 mb-4 group-hover:scale-110 transition-transform" />
              <h4 className="text-white font-bold mb-1">Caring</h4>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24">
        <div className="max-w-md w-full animate-in fade-in slide-in-from-right-4 duration-700">
          ...
          <div className="mb-10 text-center lg:text-left">
            <div className="inline-block p-3 bg-slate-900 rounded-2xl mb-6 shadow-xl shadow-slate-900/20">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="space-y-4">
              <Input
                ...
                className="!rounded-2xl !border-slate-200 focus:!border-blue-500 !p-5 transition-all !shadow-none font-semibold text-slate-900"
                required
              />
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center group cursor-pointer">
                <div className="relative flex items-center">
                  <input type="checkbox" className="peer appearance-none w-5 h-5 border-2 border-slate-200 rounded-lg checked:bg-slate-900 checked:border-slate-900 transition-all cursor-pointer" />
                  <ShieldCheck className="absolute w-3 h-3 text-white left-1 opacity-0 peer-checked:opacity-100 transition-opacity" />
                </div>
            ...
            <Button 
              type="submit" 
              className="w-full !py-5 !rounded-2xl !bg-slate-900 hover:!bg-blue-600 !text-white !font-black !text-sm uppercase !tracking-[0.3em] !shadow-2xl !shadow-slate-200 hover:!shadow-blue-200 transition-all active:scale-[0.98] flex items-center justify-center gap-2" 
              loading={loading}
            >
          ...
          <div className="mt-12">
            ...
            <Link 
              to="/register" 
              className="mt-6 flex items-center justify-center w-full py-4 rounded-2xl border-2 border-slate-200 font-black text-xs text-slate-600 uppercase tracking-widest hover:bg-white hover:border-slate-400 transition-all"
            >
              Create Account
            </Link>
          </div>
