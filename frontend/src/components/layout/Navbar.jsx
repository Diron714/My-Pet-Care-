          ...
          <div className="flex items-center gap-8">
            <Link to="/" className="flex items-center gap-2 group">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-br from-primary-500 to-emerald-500 rounded-xl blur-sm opacity-50 group-hover:opacity-75 transition-opacity"></div>
                <div className="relative h-10 w-10 rounded-xl bg-gradient-to-br from-primary-600 to-emerald-500 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all group-hover:scale-105">
                  <PawPrint className="w-6 h-6 text-white" />
                </div>
              </div>
              <span className="text-xl font-black tracking-tight text-slate-900 group-hover:text-primary-600 transition-colors">
                My Pet <span className="text-primary-600">Care+</span>
              </span>
            </Link>
            <div className="hidden md:flex items-center gap-1">
              <Link
                to="/pets"
                className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-slate-700 hover:bg-primary-50 hover:text-primary-700 transition-all duration-200 group"
              >
            ...
            {isAuthenticated ? (
              <>
                {user?.role === 'customer' && (
                  ...
                  >
                    <ShoppingCart className="w-5 h-5 text-slate-700 group-hover:text-primary-600 transition-colors" />
                    {cartItemCount > 0 && (
                ...
                <Link 
                  ...
                  className="relative p-2.5 rounded-xl hover:bg-slate-100 transition-all duration-200 group"
                >
                  <Bell className="w-5 h-5 text-slate-700 group-hover:text-primary-600 transition-colors" />
                  {unreadCount > 0 && (
                    <span className="absolute -top-1 -right-1 bg-gradient-to-br from-red-500 to-rose-600 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-lg border-2 border-white">
                      {unreadCount}
                    </span>
                ...
                <div className="relative group">
                  <button className="flex items-center space-x-2 px-3 py-2 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 hover:from-primary-50 hover:to-primary-100 border border-slate-200 hover:border-primary-300 transition-all duration-200 group">
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl py-2 border border-slate-100 hidden group-hover:block z-50">
                    <Link 
                      to={getDashboardPath()} 
                      className="flex items-center gap-3 px-4 py-3 text-slate-700 hover:bg-primary-50 hover:text-primary-700 transition-colors group"
                    >
              ...
              <>
                <Link
                  to="/login"
                  className="px-4 py-2 text-sm font-semibold text-slate-700 hover:text-primary-600 rounded-xl hover:bg-primary-50 transition-all duration-200"
                >
                  Login
                </Link>
                <Link 
                  to="/register" 
                  className="px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-br from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 active:scale-95"
                >
                  Register
                </Link>
              </>
